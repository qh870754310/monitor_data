...
import monitordata.util.HttpClientHelper;
...
public class NetController {
    ...
    public String queryStorageDevice(String openID, String deviceSeries, String dn) throws Exception {
     ...
     * @throws Exception
     */
    public static String queryDeviceList(final String openID, String serverType) throws Exception {
        //set the URL and method
     ...
     * @throws Exception
     */
    public static String queryDevice(final String openID, final String dn) throws Exception {
        System.out.println(openID);
        //set the URL and method
    ...
    public static String queryNeDeviceTest() throws Exception {
        JSONObject jsonObject = new JSONObject();
        String openID = getOpenID();
        //set the URL and method
        ...
        parameters.add(new BasicNameValuePair("start", ""));
        parameters.add(new BasicNameValuePair("size", "500"));
        parameters.add(new BasicNameValuePair("orderby", ""));
        parameters.add(new BasicNameValuePair("desc", ""));
     ...
     * get the result
     */
    public static String getResult(final HttpResponse response) throws IllegalStateException, IOException {
    ...
    public static Map<String, String> parseResponse(final String input) {
    ...
    public String getServerInfo(String dn, HttpServletRequest request) throws IOException {
        return "redirect:/net/device/detail?dn=" + dn; //重定向到华为网管系统
    }

    @RequestMapping("/getDataGrid")
    public void  getDataGrid(HttpServletResponse httpServletResponse, String deviceName) {
        JSONObject jsonObject = new JSONObject();
                    ...
                    if (!StringUtils.isEmpty(deviceName)) {
                        if (json.size() > 0) {
                            for (Object obj : json) {
                                ...
                                if ("Ac4700".equals(deviceName)) {
                                    deviceName = "AC4700";
                                }
                                if (object.get("nename").equals(deviceName)) {
